...
export default function MedicineInfo(props) {
    ...
    let display = (
      <div>
        ...
        <p>
          ...
          <Link
            to={{
              pathname: `/manufacturer/view-transaction/${data[7]}`,
  ...
  function sendPackage() {
    ...
    supplyChain.methods
      .sendPackageToEntity(wholesaler, account, medicineAddress, signature)
      .send({ from: account })
    ...
    return (
      <div>
        ...
        <Button variant="contained" color="primary">
          <Link
            to={{
              pathname: `/manufacturer/view-request/${medicineAddress}`,
              query: {
