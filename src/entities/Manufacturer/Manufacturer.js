...
export default function Manufacturer({ ...rest }) {
  const switchRoutes = (
    <Switch>
      ...
      <Route
        exact
        path="/manufacturer/view-raw-material/:id"
        component={ReceivedRawMaterial}
      />
      <Route
        exact
        path="/manufacturer/view-medicine/:id"
        component={MedicineInfo}
      />
      <Route
        exact
        path="/manufacturer/view-transaction/:id"
        component={ViewTransactions}
      />
      <Route
        exact
        path="/manufacturer/view-request/:id"
